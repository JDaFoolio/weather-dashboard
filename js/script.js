function initPage() {
    ...
    function getWeather(cityName) {
        // Grabs current weather for city from openweather api
            ...
            .then(function (response) {
                ...
                axios.get(UVQueryURL)
                    .then(function (response) {
                        ...
                        // UV < 4 blue, UV < 8 yellow, UV > 8 red badges
                ...
                axios.get(forecastQueryURL)
                    .then(function (response) {
                        ...
                        for (i = 0; i < forecastEls.length; i++) {
                            ...
                            // Icon for current weather in searched city
    ...
    // Get the history from local storage if applicable
